function WaitlistForm({ buttonText = "Notify Me" }) {
  return (
    <form
      ...
      method="post"
      className="mx-auto mt-12 max-w-xl rounded-[34px] border border-[rgba(31,28,23,0.08)] bg-[rgba(255,255,255,0.78)] p-3 shadow-[0_18px_60px_rgba(58,44,28,0.06)] backdrop-blur"
    >
      <div className="flex flex-col gap-3 sm:flex-row">
        <input
          ...
          required
          className="h-14 rounded-[22px] bg-[#1F4A3A] px-8 text-sm font-medium tracking-[0.08em] text-white transition duration-300 hover:bg-[#183b2f] hover:shadow-[0_10px_24px_rgba(31,74,58,0.18)]"
        />
        <button
          type="submit"
          className="h-14 rounded-[20px] bg-[#1F4A3A] px-7 text-sm font-medium tracking-[0.08em] text-white transition hover:bg-[#183b2f]"
        >
          {buttonText}
        </button>
      </div>
      <p className="mt-3 text-xs text-[rgba(31,28,23,0.34)]">
      ...
      <main>
        <section className="mx-auto max-w-5xl px-6 pb-24 pt-28 text-center md:pt-32">
          <div className="text-[11px] uppercase tracking-[0.42em] text-black/38">
            ...
            <h1
              className="aga-fade-up aga-delay-1 mt-8 text-6xl sm:text-7xl md:text-[96px] leading-[0.94] tracking-[-0.03em] text-[#1F1C17]"
          ...
          <p className="aga-fade-up aga-delay-2 mx-auto mt-7 max-w-2xl text-[17px] leading-8 text-[rgba(31,28,23,0.62)] sm:text-[18px]">
          ...
          <section className="mx-auto max-w-5xl px-6 pt-20 pb-32 text-center">
            <div className="aga-fade-up aga-delay-4 mx-auto mb-14 h-px w-20 bg-[rgba(31,28,23,0.10)]" />

            <div className="aga-fade-up aga-delay-5 grid grid-cols-1 gap-12 sm:grid-cols-3">
              <div>
          ...
          <img
            ...
            className="h-[340px] sm:h-[460px] md:h-[580px] w-full object-cover"
          />
        </div>
        </section>
        ...
        <section className="mx-auto max-w-4xl px-6 pb-28 text-center">
          <div className="aga-fade-up text-[11px] uppercase tracking-[0.42em] text-[rgba(31,28,23,0.38)]">
            Why It Matters
          </div>
